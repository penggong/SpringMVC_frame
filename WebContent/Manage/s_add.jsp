...
<html>
  ...
  <script type="text/javascript">
       function mycheck(){
		   ...
		   if(from_s_add.s_member.value==""){  
		   alert("请输入学生学号！"); 
		   return false;
		   }
		   /* if(from_s_add.s_academy.value==""){  
		   alert("请输入学生学院信息！"); 
		   return false;
		   }
		   if(from_s_add.s_major.value==""){  
		   alert("请输入专业信息！"); 
		   return false;
		   } */
		   if(from_s_add.s_class.value==""){  
		   alert("请输入班级信息！"); 
		   return false;
		   }
		   if(from_s_add.s_idcard.value==""){  
		   alert("请输入身份证信息！"); 
		   return false;
		   }
		   if(from_s_add.s_source.value==""){  
		   alert("请输入生源地信息！"); 
		   return false;
		   }
		   if(from_s_add.s_enteryear.value==""){  
		   alert("请输入入学年份信息！"); 
		   return false;
		   }
        }
  ...
  <body>
	...
	<div style="position: absolute; left: 240px; top: 90px; width: 330px;">
	   <form name="from_s_add" action="${pageContext.request.contextPath}/student/student_add.action" method="post" onSubmit="return mycheck()">
	           <div>
			<br>
			  &nbsp;&nbsp;&nbsp;&nbsp;学生姓名:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="s_name" id="s_name"><br><br>
			  &nbsp;&nbsp;&nbsp;&nbsp;学号:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="s_member" id="s_member"><br><br>
			  &nbsp;&nbsp;&nbsp;&nbsp;性别:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;班级:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="s_class" id="s_class"><br><br>
			  &nbsp;&nbsp;&nbsp;&nbsp;身份证号码:  <input type="text" name="s_idcard" id="s_idcard"><br><br>
			  &nbsp;&nbsp;&nbsp;&nbsp;生源地:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="s_source" id="s_source"><br><br>
			  &nbsp;&nbsp;&nbsp;&nbsp;入学年份:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="s_enteryear" id="s_enteryear"><br><br>
			 
			  
			  
			  
			</div>
			<div style="position:absolute;left:100px;top:450px"><input type="submit" value="添加"></div>
	   </form>
	</div>
	<script type="text/javascript">
